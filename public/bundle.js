...
/* harmony import */ var _task_edit_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./task-edit.js */ "./src/task-edit.js");
...
function renderTasks(amount) {
  for (let i = 0; i < amount; i++) {
    let taskData = Object(_make_task_js__WEBPACK_IMPORTED_MODULE_0__["makeTaskData"])();
    tasks.push(taskData);

    let task = new _task_js__WEBPACK_IMPORTED_MODULE_2__["default"](taskData);
    let taskEdit = new _task_edit_js__WEBPACK_IMPORTED_MODULE_3__["default"](taskData);
...
/*!**************************!*\
  !*** ./src/make-task.js ***!
  \**************************/
/*! exports provided: makeTaskData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeTaskData", function() { return makeTaskData; });
...
class TaskEdit extends _component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
  ...
  _onChangeColor(evt) {
    const color = evt.target.closest(`.card__color-input`);
  ...
  createListeners() {
    ...
    if (this._state.isDate) {
      flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(".card__date", { altInput: true, altFormat: "j F", dateFormat: "j F" });
      flatpickr__WEBPACK_IMPORTED_MODULE_1___default()(".card__time", { enableTime: true, noCalendar: true, altInput: true, altFormat: "h:i K", dateFormat: "h:i K"});
    }
...
class Task extends _component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(data) {
    super();
    this._title = data.title;
    this._dueDate = data.dueDate;
